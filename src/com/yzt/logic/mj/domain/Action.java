...
public class Action implements Serializable {
	...
	private static final long serialVersionUID = -8320233076356729279L;
	private Integer type;// 11长毛组合(亮毛) ,12是长毛, 2碰 3点杠 4碰杠 5暗杠
	private Long createTime;
	private Long userId;// 执行动作人
	private Long toUserId;// 被执行动作人
	private Integer actionId;// 行为编码
	private Integer extra;// 吃的牌 碰的牌 杠的牌 1-34中的.
