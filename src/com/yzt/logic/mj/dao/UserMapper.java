...
//                MyBatisUtils.closeSessionAndCommit();
    ...
    public static Integer isExistUserId(String userId) {
        ...
        try {
            ...
            log.error("isExistUserId数据库操作出错！");
            e.printStackTrace();
        }finally {
            session.close();
        }
...
//                MyBatisUtils.closeSessionAndCommit();
    ...
    public static Integer getUserMoneyByUserId(Long userId) {
        ...
        try {
            ...
            log.error("数据库操作出错！getUserMoneyByUserId");
            e.printStackTrace();
        } finally {
            session.close();
        }
...
//	                MyBatisUtils.closeSessionAndCommit();
	...
	public static String findIpByUserId(Long userId) {
	        ...
	        try {
	        	...
	        	log.error("findIpByUserId数据库操作出错！");
	            e.printStackTrace();
	        }finally {
	            session.close();
	        }
